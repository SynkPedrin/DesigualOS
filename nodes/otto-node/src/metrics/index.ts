...
/**
 * Mesmas métricas do desigual-node (copiadas, não compartilhadas em package:
 * cada node é um processo independente e o acoplamento via package novo não
 * se paga pra 50 linhas de leitura de SO).
 */
