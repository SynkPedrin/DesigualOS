...
/** Polling, not the WS channel (no real client for it yet, see src/lib/monitoring/system-events.ts):
 * this only needs to catch up on notifications the user missed while away (e.g. a Studio job
