 ...
 * uma janela em que tudo aparece caído sem estar. 10s dá margem de sobra e
 * mantém o Monitoramento atualizado quase ao vivo; é barato: são 4
 * requisições HTTP curtas.
 */
