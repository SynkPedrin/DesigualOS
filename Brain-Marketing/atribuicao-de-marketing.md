...
comando_relacionado: measure
aplica_a_nichos: [medico, estetica, advocacia, contabil, agencia]
scope_fit_min_plano: growth
intencoes: [atribuição, "de onde vêm os leads", mensuração, ROI de marketing, UTM, "qual canal converte", alocação de verba]
...
- **Primeiro toque:** crédito à primeira interação. Bom para entender geração de consciência.
- **Último toque:** crédito à última interação. Bom para entender o que fecha.
- **Linear:** crédito igual a todos os pontos de contato. Bom para ver a jornada inteira.
- **Decaimento temporal:** mais crédito aos toques recentes. Bom para otimização.
- **Data-driven (ML):** atribuição por modelo. Padrão-ouro, mas exige volume de dados.

## Implementação
- Comece simples (primeiro + último toque) e evolua para multi-toque.
