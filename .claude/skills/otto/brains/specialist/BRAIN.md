...
> Migrado de `specialist.md`. Nada aqui foi inventado.
...
- Reunião de site (concluída)
- Ajuste de site (concluído)

> Relação de desenvolvimento, não de comunicação. Sem pendências registradas.
