...
> Migrado de `arquivos clientes/CLIENTES/CLIENTE_17_YAK_SUSHIBAR/`. Nada aqui foi inventado.
...
- **Marca:** YAK SUSHIBAR
- **Segmento:** Alimentação, restaurante japonês
- **Onde atua:** `[FALTA]`
- **Status:** Ativo — sem histórico de trabalho
...
`[FALTA]` — cliente identificado apenas pelo cadastro no workspace (ClickUp ID 901411883503), sem histórico de trabalho associado nas fontes.
