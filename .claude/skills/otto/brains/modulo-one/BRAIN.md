...
> Migrado de `modulo-one.md`. Nada aqui foi inventado.
...
- LP Modulo One (concluída)
- Ajustes de site, duas rodadas (concluídas)
- Publicação da versão final (concluída)

> Relação de desenvolvimento, não de comunicação. Sem pendência registrada.
