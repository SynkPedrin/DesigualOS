...
> Migrado de `arquivos clientes/CLIENTES/CLIENTE_15_APAE/`. Nada aqui foi inventado.
...
- **Marca:** APAE
- **Segmento:** Terceiro setor, assistência
- **Onde atua:** `[FALTA]`
- **Status:** Ativo
...
- Criação de textos de cards e legendas para social

### Restrição de segmento (vale mesmo sem brain preenchido)
Terceiro setor com pessoas assistidas em imagem: **política de uso de imagem e autorização é obrigatória**, especialmente com crianças e adolescentes. `[CONFIRMAR: existe termo de autorização de imagem?]` Não produzir peça com rosto identificável sem essa resposta.
