...
> Migrado de `arquivos clientes/CLIENTES/CLIENTE_13_DA_MATA/ + da-mata.md`. Nada aqui foi inventado.
...
- **Marca:** DA MATA
- **Segmento:** Sucroenergético, cana-de-açúcar
- **Onde atua:** `[FALTA]`
- **Status:** Ativo
...
- Copy institucional para site
- Roteiros de vídeo institucional e de **comemoração de 20 anos**
- Site institucional com **13 itens pendentes**, aguardando aprovação (herdado da saída de Gabriel Valenço). Atendimento: Alicia

### Ativo narrativo disponível
**Os 20 anos da marca.** É o único ativo de storytelling confirmado deste cliente — data redonda, verificável, e já roteirizada em vídeo.
