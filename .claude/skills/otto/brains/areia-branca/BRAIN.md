...
> Migrado de `arquivos clientes/CLIENTES/CLIENTE_09_AREIA_BRANCA/`. Nada aqui foi inventado.
...
- **Marca:** AREIA BRANCA
- **Segmento:** Imobiliário, empreendimento
- **Onde atua:** `[FALTA]`
- **Status:** Ativo
...
- Criação e validação de layouts **por quinzena**, rotina mensal
- Análise de campanha e apresentação produzidas em conjunto com Jardim do Lago
- Terceiro maior volume de tarefas de criação da carteira até julho/2026: 40 tarefas em uma única designer
- Conta Meta (Jardim do Lago & Areia Branca): `415999075110710`

> Conta de **alto volume operacional de criação** e baixo contexto estratégico. É a combinação que mais produz peça genérica — priorizar o preenchimento deste brain.
