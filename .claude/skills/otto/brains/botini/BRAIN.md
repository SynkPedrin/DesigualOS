...
> Migrado de `arquivos clientes/CLIENTES/CLIENTE_22_BOTINI/`. Nada aqui foi inventado.
...
- **Marca:** BOTINI
- **Segmento:** Indústria ou comércio de equipamentos
- **Onde atua:** `[FALTA]`
- **Status:** Pontual
...
- Captação fotográfica de cinco equipamentos
- Edição das imagens para catálogo, prazo 07/04/2026. **Briefing literal:** fotos tratadas, alta qualidade, **quadradas**, sem imperfeições na máquina
- Tarefa pai sob Alicia, cinco subtarefas para a designer Ana Luiza
- **Sem lista própria no ClickUp** — demanda lançada na lista da Agência Desigual, o que dificulta rastreio
